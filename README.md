...
6. Training a model that includes an additional term that penalizes difference in Graphical lasso in the loss function - synthetic data generation using this approach.
